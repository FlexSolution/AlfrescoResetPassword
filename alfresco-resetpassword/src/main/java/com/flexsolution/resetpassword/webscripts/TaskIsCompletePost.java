            ...
            TenantUtil.runAsUserTenant(new TenantUtil.TenantRunAsWork<Object>() {
                ...
                public Object doWork() throws Exception {
                    ...
                    HistoricTaskInstanceQuery query = historyService.createHistoricTaskInstanceQuery()
                            ...
                            .processVariableValueEquals("fs-reset_token", resetPasswordToken)
                            .asc();

                    List<HistoricTaskInstance> cnadidateTasks = query.list();
                    HistoricTaskInstance historicTaskInstance = cnadidateTasks.get(0);
